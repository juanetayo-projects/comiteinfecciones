...
import { Plus, Paperclip, Pencil, Trash2, Stethoscope, ArrowLeft, BarChart3, Eye } from 'lucide-react'
...
const EXPORT_COLS = [
  ...
  { key: 'criterio_4_movilizacion',  label: 'Movilización', width: 12 },
  { key: 'criterio_5_riesgo_disfagia', label: 'Riesgo Disfagia', width: 14 },
...
export default function AdherenciaPrevencionNc() {
  ...
  async function load() {
    const { data: rows } = await supabase
      .from('encuesta_adherencia_prevencion_nc')
      .select('*')
  ...
  async function handleDelete(id) {
    ...
    await supabase.from('encuesta_adherencia_prevencion_nc').delete().eq('id', id)
  ...
  const columns = [
    ...
    { key: 'criterio_4_movilizacion', header: 'Movilización', render: v => <BadgeSiNoNa v={v} /> },
    { key: 'criterio_5_riesgo_disfagia', header: 'Riesgo Disfagia', render: v => <BadgeSiNoNa v={v} /> },
    ...
    <div className="p-6 lg:p-8 animate-fade-in">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="page-title">Adherencia Prevención NC</h1>
            <p className="page-subtitle">Neumonía clínica / intrahospitalaria</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Link to="/encuestas/adherencia-prevencion-nc/dashboard" className="btn-secondary text-xs gap-1.5">
            <BarChart3 className="w-3.5 h-3.5" /> Dashboard
          </Link>
          {puedeCapturar && (
            <Link to="/encuestas/adherencia-prevencion-nc/nuevo" className="btn-primary text-xs gap-1.5">
      ...
      <div className="card p-4">
        ...
        <div className="flex justify-end mb-3">
          <ExportButtons
            ...
            columns={EXPORT_COLS}
            filename="adherencia_prevencion_nc"
            title="Adherencia Prevención NC"
        ...
        {loading ? (
          ...
          <DataTable
            ...
            emptyMessage="No hay registros de adherencia prevención NC"
            actions={row => (
              <div className="flex items-center justify-end gap-1">
                ...
                {rol !== 'auxiliar' && (
                  <Link to={`/encuestas/adherencia-prevencion-nc/${row.id}/editar`}
